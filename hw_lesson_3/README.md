...
## Задание: 
  1. [Создание сети и предварительная настройка коммутаторов](https://github.com/klyuchnikovn/net_eng/tree/master/hw_lesson_3/README.md#создание-сети-и-предварительная-настройка-коммутаторов "Создание сети и предварительная настройка коммутаторов")
  2. [Выбор root bridge](https://github.com/klyuchnikovn/net_eng/tree/master/hw_lesson_3/README.md#выбор-root-bridge "Выбор root bridge")
